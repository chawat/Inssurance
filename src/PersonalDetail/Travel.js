...
offering the same benefits with different Medical Expenses limits:
          ...
          <div>Embark on worry-free travels with NEXTGUARD's Travel Insurance and Assistance Plan. Our comprehensive coverage ensures peace of mind during your journeys, offering essential medical expenses, emergency assistance, and provisions for dependent children. Additional optional covers are available for sports activities abroad. With flexible policies ranging from 5 days to 2 years, and group rates, we cater to diverse needs. Choose the plan that suits you, with coverage across three geographical zones and options for individuals up to 80 years old.</div>
